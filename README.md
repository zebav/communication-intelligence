...
The prototype works without credentials. Copy `.env.example` to `.env.local` when connecting a Supabase test project. See `ARCHITECTURE.md`, `SECURITY.md`, and `DEPLOYMENT.md` before production work.
