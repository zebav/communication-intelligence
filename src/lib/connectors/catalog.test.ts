...
describe("universal connector catalog", () => {
  ...
  it("describes planned channels without claiming they are connected", () => { expect(connectorById("instagram-professional")?.availability).toBe("planned"); expect(connectorById("whatsapp-business")?.accountAudience).toBe("business-account"); });
